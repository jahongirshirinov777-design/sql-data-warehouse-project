...
PRINT '=========================================================';
PRINT 'Stored Procedure: Load Silver Layer (Source > Silver)';
PRINT 'Script Purpose: This stored procedure loads data into the silver schema from bronze layer.';
PRINT 'It Truncates the silver tables before loading data. And then uses Bulk Insert command to load data to the tables.';
PRINT 'Usage Example: EXEC silver.load_silver';
PRINT '=========================================================';
